...
if(isset($_POST['updateUser'])){
    ...
    $update_sql = "UPDATE op_users SET FIRSTNAME='".$firstname."',LASTNAME='".$lastname."',EMAIL='".$email."',MOBILE='".$mobile."',USER_LEVEL='".$access."',DATE_MODIFIED='".$datetime."' WHERE USER_ID='".$user_id."'";
