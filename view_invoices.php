...
$invoice_search_sql = "select SUM(INVOICE_TOTAL) as totalSales, SUM(TOTAL_CASH) as cash, SUM(TOTAL_CARD) as card,SUM(INVOICE_PROFIT) as profit from op_invoice_main WHERE INVOICE_DATE BETWEEN '".$fromDate."' AND '".$toDate."'";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Search Invoices</h1>
          </div><!-- /.col -->
                ...
                <table class="table">
                  <tbody><tr>
                    ...
                    <th>Payment Status</th>
                      ...
                      include 'actions/dbconnection.php';
                      $date = date("Y-m-d");
                      $today_invoice_sql = "select * from op_invoice_main WHERE INVOICE_DATE BETWEEN '".$fromDate."' AND '".$toDate."'";
